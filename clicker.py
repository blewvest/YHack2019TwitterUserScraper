...
#Push the found tweets to Google Firestore

#OLD CODE for Real Time Database - Functional, but bad readibility
#firebase = firebase.FirebaseApplication('https://university-admissions-insider.firebaseio.com/',None)
#result=firebase.post('/tweets',{full_name:catTweets})
